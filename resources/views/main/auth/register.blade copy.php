...
<main class="container-fluid h-100 main-container">
    ...
    <div class="row h-100">
        ...
        <div class="col-12 mx-auto text-center" style="margin-top: 150px">
            <div class="row h-100">
