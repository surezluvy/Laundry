                        ...
                        <div id="modalAdd" class="modal text-left" tabindex="-1" role="dialog" aria-labelledby="exampleModalPopoversLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="{{ route('add-mitra') }}">
                                        @csrf
                                        <div class="modal-body">
                                            <h5 class="modal-text text-center">Tambah data mitra</h5>
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <form method="post" action="{{ route('mitra-delete', $d->user_id) }}">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <h7 class="modal-text">Apakah anda yakin akan menghapus mitra <strong>{{ $d->full_name }}</strong>?</h7>
                                                </div>
                                                <div class="modal-footer">
                                                <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Batal</button>
